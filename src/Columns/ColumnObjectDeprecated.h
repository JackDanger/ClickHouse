...
public:
    ...
    StringRef serializeValueIntoArena(size_t, Arena &, char const *&, IColumn::SerializationSettings *) const override { throwMustBeConcrete(); }
    char * serializeValueIntoMemory(size_t, char *, IColumn::SerializationSettings *) const override { throwMustBeConcrete(); }
    void deserializeAndInsertFromArena(ReadBuffer &, IColumn::SerializationSettings *) override { throwMustBeConcrete(); }
